<html lang="zh-CN">
	<head>
		...
		<style>
body {
	background: url(/book/image/loginbg.png) repeat-x;
	min-height: 600px;
	position: relative;
}
...
.kuico {
	background: url(/book/image/coolyun.png) no-repeat;
...
.kutrg {
	background: url(/book/image/triangle.png) no-repeat;
	display: inline-block;
	width: 10px;
	height: 6px;
}
...
.robot {
	background: url(/book/image/android.png) no-repeat;
	display: inline-block;
	width: 18px;
	height: 20px;
	padding-right: 5px;
...
.question {
	background: url(/book/image/question.png) no-repeat;
	display: inline-block;
	width: 20px;
	height: 20px;
	padding-right: 5px;
...
.downApk {
	background: url(/book/image/android.png) no-repeat 30px;
	text-indent: 25px;
	display: inline-block;
	height: 32px;
	line-height: 32px;
...
.introduce {
	background: url(/book/image/question.png) no-repeat 20px;
	text-indent: 20px;
	display: inline-block;
	height: 32px;
	line-height: 32px;
...
#cloud {
	background: url(/book/image/cloud.png) repeat;
	width: 100%;
	height: 356px;
	position: absolute;
	bottom: 0px;
...
#sky {
 	background: url(/book/image/sky.png) repeat;
 	width: 100%;
	heigth: 462px;
	z-index: -20;
	height: 462px;
...
#tlogin:focus {
	...
	<body>
		...
		<div id="head"></div>
		<div id="middle">
			<form action="/book/admin/login" method="post" modelAttribute="entity">
				<ul style="text-align: center;">
					<li style="font-size: 48px"> 
						通用教学管理系统
					</li>
					<li>
						<input class="name" name="user_name" placeholder="请输入用户名">
					</li>
					<li>
						<input type="password" name="user_password" class="pwd" placeholder="请输入密码">
					</li>
					<li>
		...
		<div id="cloud"></div>
		<script src="/book/script/jquery-2.1.1.js" type="text/javascript"
