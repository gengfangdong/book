    ...
    <div class="main">
        ...
        <table border="1" width="100%" class="tab">
            ...
            <#list suggestion_list as suggestion>
                    ...
                    <input type="hidden" name="suggestion_qq" value="${suggestion.suggestion_qq}"/><td>${suggestion.suggestion_qq}</td>
                    <td>
                    <input type="hidden" name="suggestion_flag" value="0"/>
                    <a href="#" class="abtn" onClick="document.getElementById('form${suggestion.suggestion_id}').submit()">标记未读</a>
                    <a href="delete/${suggestion.suggestion_id}" class="abtn" >删除</a>
                    </td>
                   </tr>
                   </form>
           </#list> 
